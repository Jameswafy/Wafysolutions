...
INDEX `fk_SUBREGION_REGION_idx` (`REGION_ID` ASC),
...
INDEX `fk_MONTH_YEAR1_idx` (`YEAR_ID` ASC),
...
INDEX `fk_DAY_MONTH1_idx` (`MONTH_ID` ASC),
...
`DAY_ID`),
INDEX `fk_FACTS_TICKET_BOOKS1_idx` (`BOOKS_ISBN` ASC),
